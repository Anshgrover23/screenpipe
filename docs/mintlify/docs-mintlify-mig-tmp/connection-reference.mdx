...
| --- | --- | --- |
| OAuth | Gmail, Google Calendar, Google Docs, Notion, Jira, Inoreader, Microsoft 365, Teams, Vercel, Supabase, Zoom | best user experience; tokens are stored locally |
...
| productivity | Notion, Obsidian, Google Calendar, Google Docs, Google Sheets, Microsoft 365, Inoreader, Logseq, Airtable, Confluence |
...
| daily notes and reading | Obsidian, Logseq, Google Docs, Inoreader |
